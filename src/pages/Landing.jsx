            ...
            <div class="col">
              <div class="card mb-4 rounded-3 shadow-sm">
                ...
                <div class="card-body">
                  ...
                  <br />
                  <Link to="/uno" ><button type="button" class="w-100 btn btn-lg btn-dark btn-outline-warning">Suscribirme</button></Link>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card mb-4 rounded-3 shadow-sm">
                ...
                <div class="card-body">
                  ...
                  <Link to="/dos" ><button type="button" class="w-100 btn btn-lg btn-dark btn-outline-warning">Suscribirme</button></Link>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card mb-4 rounded-3 shadow-sm border-primary">
                ...
                <div class="card-body">
                  ...
                  <Link to="/tres" ><button type="button" class="w-100 btn btn-lg btn-dark btn-outline-warning">Suscribirme</button></Link>
                </div>
              </div>
            </div>
